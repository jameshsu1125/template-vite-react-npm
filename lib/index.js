...
See https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.`
      ...
      var Te = Array.isArray, Ue = Symbol.for("react.client.reference"), E = {
        H: null,
        A: null,
        T: null,
        S: null,
      ...
      var Oe, Ae, ke = {}, He = C.react_stack_bottom_frame.bind(
        C,
        G
      )(), qe = be(z(G)), Se = !1, Ce = /\/+/g, Pe = typeof reportError == "function" ? reportError : function(e) {
        if (typeof window == "object" && typeof window.ErrorEvent == "function") {
                ...
                function(oe) {
                  if (O(r, o), o === 0) {
                    try {
                      ...
                      E.thrownErrors.push(We);
                    }
                    if (0 < E.thrownErrors.length) {
                      var xe = N(
                        E.thrownErrors
                      );
                      E.thrownErrors.length = 0, V(xe);
                    }
                  } else m(oe);
                },
                function(oe) {
...
var Le;
function Fe() {
  return Le || (Le = 1, process.env.NODE_ENV === "production" ? ve.exports = Ge() : ve.exports = Be()), ve.exports;
}
/**
 * @license React
...
var De;
function Xe() {
  return De || (De = 1, process.env.NODE_ENV === "production" ? Ee.exports = ze() : Ee.exports = Qe()), Ee.exports;
}
var Ve = Xe();
const Ke = () => (alert("aaa"), /* @__PURE__ */ Ve.jsx("div", { children: "app" }));
export {
  Ke as default
};
